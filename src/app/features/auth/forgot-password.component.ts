...
/**
 * Requests a password-reset email. The backend always responds 204 (no account enumeration), so the
 * screen always switches to the neutral "check your email" state on success.
 */
@Component({
